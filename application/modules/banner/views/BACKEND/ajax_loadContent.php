...
<div class="content_table">
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			...
			<th class="th_left" onclick="sort('name')"><div id="name" class="sort icon_no_sort">Link Image</div></th>
			<th class="th_left" onclick="sort('domain')"><div id="domain" class="sort icon_no_sort">Description</div></th>
		...
		<tr class="item_row<?=$i?> <?php ($k%2==0) ? print 'row1' : print 'row2' ?>">
			...
			<td class="th_left"><a href="<?=PATH_URL.'admincp/'.$module.'/update/'.$v->id?>"><?=$v->linkimage?></a></td>
			<td class="th_left"><a href="<?=PATH_URL.'admincp/'.$module.'/update/'.$v->id?>"><?=$v->description?></a></td>
